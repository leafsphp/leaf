...
$app->get('/posts', function() use($app) {
    ...
    foreach ($posts as $post) {
        $post["created_at"] = $post["created_at"] == null ? null : $app->date->ts_to_english_ts($post["created_at"]);
        $post["updated_at"] = $post["updated_at"] == null ? null : $app->date->ts_to_english_ts($post["updated_at"]);
