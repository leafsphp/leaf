...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
	<link rel="stylesheet/less" type="text/css" href="<?php echo static::$conf['base_url']; ?>views/lib/bootstrap.less"></link>
	<script src="<?php echo static::$conf['base_url']; ?>views/js/less-1.1.5.min.js"></script>
    <style type="text/css">
      body {
        padding-top: 60px;
      }
    ...
    <link rel="shortcut icon" href="<?php echo static::$conf['base_url']; ?>views/images/favicon.ico">
    <link rel="apple-touch-icon" href="<?php echo static::$conf['base_url']; ?>views/images/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo static::$conf['base_url']; ?>views/images/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo static::$conf['base_url']; ?>views/images/apple-touch-icon-114x114.png">
  </head>
