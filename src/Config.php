...
class Config
{
    ...
    protected static $context = [
        ...
        'session.cookie' => ['secure' => null, 'httponly' => true, 'samesite' => 'lax'],
        'scripts' => [],
        'views.path' => null,
    ...
    public static function reset()
    {
        static::$context = [
            ...
            'session' => static::$context['session'],
            'session.lifetime' => static::$context['session.lifetime'],
            'session.cookie' => static::$context['session.cookie'],
            'scripts' => [],
