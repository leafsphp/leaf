...
class Util
{
     ...
     * @param  \Leaf\Http\Headers $headers The Response headers
     * @param  \Leaf\Http\Cookies $cookies The Response cookies
     * @param  array              $config  The Leaf app settings
     */
    public static function serializeCookies(\Leaf\Http\Headers &$headers, \Leaf\Http\Cookies $cookies, array $config)
    {
     ...
     *
     * This method will construct and set the HTTP `Set-Cookie` header. Leaf
     ...
     *
     * This method accepts the Leaf_Http_Headers object by reference as its
     ...
     * is already set in the HTTP response, it will also be removed. Leaf uses this method
